...
import br.dev.isac.transacaoapi.busisness.services.EstatisticasService;
...
public class EstatisticasController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Erro na busca de estatisticas devtransações"),
    ...
    public ResponseEntity<EstatisticasResponseDTO> buscarEstatisticas(@RequestParam(value = "intervaloBusca", required = false, defaultValue = "60") Integer intervaloBusca) {
        return ResponseEntity.ok(estatisticasService.calcularEstatisticasTransaccoes(intervaloBusca));
    }
}
